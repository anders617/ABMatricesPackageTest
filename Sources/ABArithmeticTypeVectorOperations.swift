...
*/
@warn_unused_result public func +<T:ABMatrixOperableType>(lhs:ABVector<T>, rhs:ABVector<T>) -> ABVector<T> {
...
@warn_unused_result public func +=<T:ABMatrixOperableType>(inout lhs:ABVector<T>,rhs:ABVector<T>) {
    lhs = lhs + rhs
}
...
*/
@warn_unused_result public func *<T:ABMatrixOperableType>(lhs:T, rhs:ABVector<T>) -> ABVector<T> {
...
/**
 ABMatrixOperableType ABVector scalar multiplication
*/
@warn_unused_result public func *<T:ABMatrixOperableType>(lhs:ABVector<T>, rhs:T) -> ABVector<T> {
    return rhs * lhs
}

@warn_unused_result public func *=<T:ABMatrixOperableType>(inout lhs:ABVector<T>, rhs:T) {
    lhs = lhs * rhs
}
...
*/
@warn_unused_result public func *<T:ABMatrixOperableType>(lhs:ABVector<T>, rhs:ABVector<T>) -> T {
